...
const instructions = (
  <div className="text-center">
    <h3 className="text-2xl font-bold">🔥 Test de Désalignement Rapide – Découvre en 5 minutes ton degré d'alignement avec ton TELOS et ce qui te bloque vraiment 🔥</h3>
